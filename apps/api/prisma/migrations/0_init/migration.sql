...
CREATE TABLE `houses` (
    ...
    `transfer_status` TINYINT NULL DEFAULT 0,
...
CREATE TABLE `player_kills` (
    ...
    `unavenged` TINYINT NOT NULL DEFAULT 0,
...
CREATE TABLE `players` (
    ...
    `quickloot_fallback` TINYINT NOT NULL DEFAULT 0,
    ...
    `isreward` TINYINT NOT NULL DEFAULT 1,
    `istutorial` TINYINT NOT NULL DEFAULT 0,
    `forge_dusts` BIGINT NOT NULL DEFAULT 0,
    `forge_dust_level` BIGINT NOT NULL DEFAULT 100,
    `randomize_mount` TINYINT NOT NULL DEFAULT 0,
